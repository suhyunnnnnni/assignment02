<template>
    <div id="background">
        <div class="d-flex flex-column  align-items-center mt-20 pt-20 w-100 h-100">
            <!-- title -->
            <div>
                <p class="title fs-6x fw-bold text-white mt-10">회원 가입</p>
            </div>
            ...
            <div class="d-flex justify-content-center align-items-start mt-10 w-100 h-25">
                <button class="btn fs-2 fw-bold text-white " @click="goToLogin()">돌아 가기</button>
            </div>
...
async function goToSignIn() {
    ...
    if (idInput.value && pwInput.value) {
        ...
        if(output.value == '200') {
            ...
            status.value = '알림'
            contents.value = '동일한 아이디가 있습니다 아이디를 변경하세요'
...
// 사용자 추가 요청
async function requestUserAdd(user) {
